...
class kSNPE(BaseInference):
    def __init__(self, generator, obs, convert_to_T=3,
                 ...
                 reinit_weights_each_round=False,
                 **kwargs):
        """Sequential neural posterior estimation (SNPE) with calibration kernel
        ...
        """
        assert obs is not None, "kSNPE requires observed data"
        self.obs = obs
        super().__init__(generator, **kwargs)

        self.reinit_weights_each_round = reinit_weights_each_round
